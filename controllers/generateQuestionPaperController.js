...
const generateQuestionPaperController = {};

generateQuestionPaperController.generateQuestionPaper = async (req, res) => {
    try {
...
module.exports = generateQuestionPaperController;
